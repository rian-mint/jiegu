...
// テーブル名を定義
define('TABLE_NAME_STONES', 'mt4testj');
...
foreach ($events as $event){
  ...
  // ユーザーに通知
  replyTextMessage($bot, $event->getReplyToken(), 'このLINE@は自動配信のため返答できません。');
}

// ユーザーをデータベースに登録する
function registerUser($userId) {
  $dbh = dbConnection::getConnection();
  $sql = 'insert into '. TABLE_NAME_STONES .' (userid) values (pgp_sym_encrypt(?, \'' . getenv('DB_ENCRYPT_PASS') . '\')) ';
  $sth = $dbh->prepare($sql);
